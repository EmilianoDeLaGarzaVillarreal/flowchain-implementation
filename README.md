...
# Clients
python src/client_fedrep.py --config_file config/TP/FlowChain/hotel.yml --data_fraction 1.0 > client1-FedRep.txt 2>&1
python src/client_fedrep.py --config_file config/TP/FlowChain/zara1.yml --data_fraction 1.0 > client2-FedRep.txt 2>&1
python src/client_fedrep.py --config_file config/TP/FlowChain/zara2.yml --data_fraction 1.0 > client3-FedRep.txt 2>&1
python src/client_fedrep.py --config_file config/TP/FlowChain/eth.yml --data_fraction 1.0 > client4-FedRep.txt 2>&1
```
